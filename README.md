# Olá, eu sou o Ruy Freire 👋

## 🚀 Engenheiro de Software | Desenvolvedor Fullstack

Especialista no ecossistema **JavaScript / TypeScript**, atuando no desenvolvimento de aplicações web escaláveis com **React, Next.js, Node.js e NestJS**.
